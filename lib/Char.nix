...
in {
  ...
  isLower = c: (builtins.match "[a-z]" c) != null;
  isAlpha = c: (builtins.match "[a-zA-Z]" c) != null;
  isAlphaNum = c: (builtins.match "[a-zA-Z0-9]" c) != null;
  isDigit = c: (builtins.match "[0-9]" c) != null;
  isOctDigit = c: (builtins.match "[0-7]" c) != null;
  isHexDigit = c: (builtins.match "[0-9a-fA-F]" c) != null;
}
